...
class Board:
    ...
    def check_move(self, row, col, piece, possible_move_row, possible_move_col, bool):
...
# by more than 1 piece the second check is not being detected and wrong moves are allowed
    ...
    # Create copies of the piece and the board
        ...
        # Hypothetically perform the move
        ...
        #if not self.squares[king_positions[0][0]][king_positions[0][1]].isempty() and not self.squares[king_positions[1][0]][king_positions[1][1]].isempty():
        #    print(self.squares[king_positions[0][0]][king_positions[0][1]].piece.color, king_positions[0])
        #    print(self.squares[king_positions[1][0]][king_positions[1][1]].piece.color, king_positions[1])
        # If there are 2 kings on the board, check their adjacency
        if len(king_positions) == 2:
            row_diff = abs(king_positions[0][0] - king_positions[1][0])
            col_diff = abs(king_positions[0][1] - king_positions[1][1])
            if row_diff <= 1 and col_diff <= 1:
                check = True # Kings are adjacent, invalid move
        ...
        if check:
          ...
          # No check or adjacency issues found, valid move
            ...
            for possible_move_row in range(start, end, piece.dir):
                if Square.in_range(possible_move_row):
                    if self.squares[possible_move_row][col].isempty():
                        ...
                        self.check_move(row, col, piece, possible_move_row, col, bool)
                    # blocked
                    else: break
                # not in range
                else: break
            ...
            for possible_move_col in possible_move_cols:
                if Square.in_range(possible_move_row, possible_move_col):
                    if self.squares[possible_move_row][possible_move_col].has_rival_piece(piece.color):
                        ...
                        self.check_move(row, col, piece, possible_move_row, possible_move_col, bool)
            # en passant moves
